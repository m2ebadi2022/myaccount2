...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "m2ebadi.myaccunt", "m2ebadi.myaccunt.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "m2ebadi.myaccunt.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
