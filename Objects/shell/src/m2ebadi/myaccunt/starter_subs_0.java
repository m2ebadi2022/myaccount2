...
if (RapidSub.canDelegate("application_error")) { return m2ebadi.myaccunt.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("service_create")) { return m2ebadi.myaccunt.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return m2ebadi.myaccunt.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return m2ebadi.myaccunt.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return m2ebadi.myaccunt.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
