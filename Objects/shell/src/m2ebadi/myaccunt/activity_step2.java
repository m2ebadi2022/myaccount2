...
public static m2ebadi.myaccunt.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",activity_step2.mostCurrent._activity,"activity_step1",Debug.moduleToString(m2ebadi.myaccunt.activity_step1.class),"et_email",activity_step2.mostCurrent._et_email,"et_nameFamili",activity_step2.mostCurrent._et_namefamili,"HttpUtils2Service",Debug.moduleToString(m2ebadi.myaccunt.httputils2service.class),"lbl_email",activity_step2.mostCurrent._lbl_email,"lbl_nameFamili",activity_step2.mostCurrent._lbl_namefamili,"lbl_noske",activity_step2.mostCurrent._lbl_noske,"Main",Debug.moduleToString(m2ebadi.myaccunt.main.class),"pan_all_edit",activity_step2.mostCurrent._pan_all_edit,"Starter",Debug.moduleToString(m2ebadi.myaccunt.starter.class)};
}
}