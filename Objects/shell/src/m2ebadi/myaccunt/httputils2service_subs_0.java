...
if (RapidSub.canDelegate("completejob")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
RemoteObject _job = RemoteObject.declareNull("m2ebadi.myaccunt.httpjob");
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","63014662",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
_job.runClassMethod (m2ebadi.myaccunt.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
if (RapidSub.canDelegate("hc_responseerror")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("m2ebadi.myaccunt.httpjob");
...
Debug.ShouldStop(131072);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","62949125",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("hc_responsesuccess")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("m2ebadi.myaccunt.httpjob");
...
Debug.ShouldStop(16777216);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","62818051",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("response_streamfinish")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
if (RapidSub.canDelegate("service_create")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","62555911",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","62555912",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
if (RapidSub.canDelegate("service_destroy")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
...
if (RapidSub.canDelegate("submitjob")) { return m2ebadi.myaccunt.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
Debug.ShouldStop(8192);
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (m2ebadi.myaccunt.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 80;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.ShouldStop(32768);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (m2ebadi.myaccunt.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };
