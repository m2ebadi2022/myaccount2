...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","42097158",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(131072);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","42031621",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(16777216);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","41900547",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","41638407",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","41638408",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
